            ...
            <div className="container d-flex flex-row justify-content-start align-items-center marginTop" id="header">
                ...
                <div>
                    <div class="container py-5 mx-5">
                        ...
                        <a class="btn btn-primary btn-lg" target="_blank" rel="noreferrer" href={`https://www.linkedin.com/in/davidnasrulloh/`} type="button"><FontAwesomeIcon icon={faLinkedinIn} className="me-3"/>David Nasrulloh</a>
                    </div>
                </div>
            </div>
        </>
