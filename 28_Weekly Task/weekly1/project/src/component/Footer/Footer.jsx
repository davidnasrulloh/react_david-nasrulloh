            ...
            <div className="d-flex flex-row pb-5 align-items-center">
                <div className="d-flex flex-column w-50">
                    ...
                    <div>   
                        ...
                        <p className="pt-3 align-content-center"><img src={phone} width="30" className="" alt="" /><span className="m-3">081554465073</span></p>
                        <p className="align-content-center"><img src={locationMarker} width="30" className="" alt="" /><span className="m-3">Jl. Jombang</span></p>
                    </div>
                </div>
                <div className="d-flex flex-row w-50">
                    <div className="mx-5">
                        <ul className="list-unstyled">
                            ...
                            <li className="fs-5 py-1"><a href={'p'} className="text-decoration-none text-dark">Home</a></li>
                            <li className="fs-5 py-1"><a href={'p'} className="text-decoration-none text-dark">About Us</a></li>
                            <li className="fs-5 py-1"><a href={'p'} className="text-decoration-none text-dark">Project</a></li>
                            <li className="fs-5 py-1"><a href={'p'} className="text-decoration-none text-dark">Contact</a></li>
                        </ul>
                    </div>
                    <div className="mx-5">
                        <ul className="list-unstyled">
